      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              onPressed: () {
                js.context.callMethod('profileUpdate');
              },
            ...
            ElevatedButton(
                onPressed: () {
                  js.context.callMethod('raise_event', ['Product Viewed']);
                },
                child: const Text('Product Viewed Event')),
            const SizedBox(height: 10),
            ElevatedButton(
              onPressed: () {
                js.context.callMethod('chargedEvent');
              },
